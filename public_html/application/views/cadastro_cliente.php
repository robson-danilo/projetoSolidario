             ...
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
               <ul class="nav side-menu">			   
                <li><a href="<?php echo base_url('welcome/CadastrarCliente');?>"><i class="fa fa-registered"></i> Cadastrar Cliente</a>		
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
        ...
        <div class="top_nav">
         <div class="nav_menu">
          ...
          <ul class="nav navbar-nav navbar-right">
           ...
           <li><a href="<?php echo base_url('welcome/index'); ?>"><i class="fa fa-sign-out pull-right"></i> Sair</a></li>
         </ul>
       </li>
     </ul>
   </nav>
...
<div class="tab-pane" id="endereco-tab">
 <div class="form-group">    
  <div class="col-lg-2">
   ...
   <input class="form-control" id="cliente_cep" required name="cliente_cep" type="text" size="30" onkeypress="return sem_acento(event);">  
 </div>          
</div> 
<div class="form-group"> 			
  <div class="col-lg-8">
   <label class="control-label"><label for="cliente_logadrouro">Logradouro</label></label>
   <input class="form-control" required id="cliente_logadrouro" name="cliente_logadrouro" type="text" size="30"> 
 </div> 			  
</div> 
<div class="form-group"> 
  <div class="col-lg-2">
   <label class="control-label"><label for="cliente_numero">Numero</label></label>
   <input class="form-control" required id="cliente_numero" name="cliente_numero" size="30" type="text">     
 </div>    
 <div class="col-lg-6">
   <label class="control-label"><label for="cliente_complemento">Complemento</label></label>
   <input class="form-control" required id="cliente_complemento" name="cliente_complemento" type="text" size="30"> 
 </div>  
</div>
<div class="form-group">    
  <div class="col-lg-3">
   <label class="control-label"><label for="cliente_bairro">Bairro</label></label>
   <input class="form-control" required id="cliente_bairro" name="cliente_bairro" size="30" type="text">     
 </div>  

 <div class="col-lg-3">
   <label class="control-label"><label for="cliente_municipio">Município</label></label>
   <input class="form-control" required id="cliente_municipio" name="cliente_municipio" type="text" size="30">  
 </div>  
