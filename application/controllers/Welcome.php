...
class Welcome extends CI_Controller {
	...
	public function CadastrarCliente($id=null){
		if (empty($id)){
			$dados = [
				'nome' =>'erro',
				'id' => 'ID DEU ERRO'
			...
			$dados = $this->login_model->buscar_dados($id);
	...
	public function cadastrarFlutter($flutternome, $flutteremail, $fluttersenha){

		$dados = array('nome'=> $flutternome,
					'email' => $flutternome,
					'senha' => $fluttersenha);		
		
		 $resposta = $this->login_model->inserir_flutter($dados);
