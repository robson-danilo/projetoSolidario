...
<head>
	...
	<title>Editar Dados Profissionais</title>
   ...
   <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
     <ul class="nav side-menu">	
       <li><a href="<?php echo base_url('welcome/editarperfil'); ?>"><i class="fa fa-registered"></i> Editar Perfil</a>       
        <li><a href="<?php echo base_url('welcome/editarperfilprofissional'); ?>"><i class="fa fa-registered"></i> Perfil Profissional</a>
          <li><a href="<?php echo base_url('welcome/ChatPro');?>"><i class="fa fa-registered"></i>Chat Solicitações</a>
          </ul>
        </div>
      </div>
      <!-- /sidebar menu -->
